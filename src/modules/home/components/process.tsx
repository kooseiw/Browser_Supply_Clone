...
export default function Process() {
  return (
    <section className="relative z-30 mx-auto w-full max-w-[1440px] border-t border-white/10 md:z-10">
      ...
      <div className="grid grid-cols-1 border-t border-white/10 md:h-[500px] md:grid-cols-3">
        {processData.steps.map((step, index) => (
          <div
            key={step.id}
            className={cn(
              "relative h-[300px] overflow-hidden md:h-auto",
          ...
          >
            ...
            <div className="mt-5 md:mt-0 absolute inset-0 z-20 p-5 md:p-8">
              ...
              <p className="max-w-[200px] md:max-w-xs text-sm leading-[1.6] text-white/60">
                {step.description}
              </p>
            </div>
          </div>
